// Usa caminho relativo para funcionar em qualquer porta/ambiente
const BASE_URL = '';

// Utilitário de escape para evitar XSS ao renderizar HTML dinâmico
...
// Mocks para simulação caso o backend esteja indisponível
const mockProducts = [
